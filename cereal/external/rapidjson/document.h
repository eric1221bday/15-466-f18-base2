...
public:
    ...
    */
    explicit GenericValue(Type type) CEREAL_RAPIDJSON_NOEXCEPT
        : data_()
    {
    ...
    */
    ...
    explicit GenericValue(int i) CEREAL_RAPIDJSON_NOEXCEPT
        : data_()
    {
        data_.n.i64 = i;
    ...
    explicit GenericValue(unsigned u) CEREAL_RAPIDJSON_NOEXCEPT
        : data_()
    {
        data_.n.u64 = u;
    ...
    explicit GenericValue(int64_t i64) CEREAL_RAPIDJSON_NOEXCEPT
        : data_()
    {
        data_.n.i64 = i64;
    ...
    explicit GenericValue(uint64_t u64) CEREAL_RAPIDJSON_NOEXCEPT
        : data_()
    {
        data_.n.u64 = u64;
        data_.f.flags = kNumberUint64Flag;
    ...
    explicit GenericValue(double d) CEREAL_RAPIDJSON_NOEXCEPT
        : data_()
    {
        data_.n.d = d;
    ...
    //! Constructor for constant string (i.e. do not make a copy of string)
    explicit GenericValue(StringRefType s) CEREAL_RAPIDJSON_NOEXCEPT
        : data_()
    { SetStringRaw(s); }
    ...
    */
    ...
    /*! \return (rhs == lhs)
     */
    template<typename T> friend CEREAL_RAPIDJSON_DISABLEIF_RETURN((internal::IsGenericValue<T>), (bool)) operator==(
        const T &lhs,
    ...
    */
    template<typename T>
    CEREAL_RAPIDJSON_DISABLEIF_RETURN((internal::NotExpr<internal::IsSame<typename internal::RemoveConst<T>::Type,
                                                                          Ch> >), (GenericValue & )) operator[](T *name)
    {
    ...
    bool Accept(Handler &handler) const
    {
        ...
        case kObjectType:
            ...
            for (ConstMemberIterator m = MemberBegin(); m != MemberEnd(); ++m) {
                ...
                if (CEREAL_RAPIDJSON_UNLIKELY(!handler
        ...
        default:CEREAL_RAPIDJSON_ASSERT(GetType() == kNumberType);
